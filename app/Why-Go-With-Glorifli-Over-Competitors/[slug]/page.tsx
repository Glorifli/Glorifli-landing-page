...
const competitors: Record<string, {
    ...
    smartsites: {
        ...
        glorifliGuarantee: '5 new booked appointments in 60 days or no service fee — we work free until the milestone is hit',
        ...
        faq: [
            ...
            { q: 'Does SmartSites guarantee booked appointments?', a: 'SmartSites does not publicly offer a "booked appointments or free" style guarantee. Their success metrics are typically framed around traffic growth, keyword rankings, and ROI improvements. Glorifli guarantees 5 new booked appointments in 60 days or waives the service fee.' },
    ...
    victorious: {
        ...
        faq: [
            ...
            { q: 'Does Victorious guarantee results?', a: 'Victorious does not currently offer a public "leads or free" guarantee. Glorifli guarantees 5 booked appointments in 60 days or waives the service fee entirely, continuing to work free until that milestone is reached.' },
        ],
    },
    ...
    'web-design-agencies': {
        ...
        faq: [
            ...
            { q: 'Do web design agencies guarantee appointments?', a: 'Almost no web design agency publicly guarantees a specific number of booked appointments. Their deliverable is the site itself — traffic and conversions are framed as dependent on many external factors. Glorifli\'s deliverable is the outcome: 5 booked appointments in 60 days.' },
            ...
            <div className="max-w-4xl mx-auto px-6 pb-24">
                ...
                <section className="mb-20 scroll-mt-24" id="guarantee">
                    ...
                    <p className="text-gray-400 text-lg leading-relaxed mb-4">
                        Glorifli's guarantee: 5 new appointments booked in your first 60 days after launch, or the $589.50/mo service fee is waived — we keep working until that milestone is hit. No vague "improved visibility," no retainer while you wait 12 months.
                    </p>
                    <div className="grid md:grid-cols-3 gap-5 mt-8">
                        {[
                            { step: 'Step 1', title: 'Pay $1,256.50 Setup', desc: 'Site goes live. 60-day clock starts. First month of SEO/AEO runs free.' },
                            { step: 'Step 2', title: 'We Deliver 5 Appointments', desc: 'AEO content, GBP sync, and citations drive local intent traffic to your booking engine.' },
                            { step: 'Step 3', title: 'Milestone Hit, You Decide', desc: 'Once 5 appointments are booked, choose to continue at $589.50/mo. No contract pressure.' },
                        ].map(({ step, title, desc }) => (
