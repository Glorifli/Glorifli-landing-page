...
const servicesFaqs: FAQItem[] = [
    {
        ...
        answer: (
            <>
                You will receive a comprehensive technical action plan for your website, a targeted list of local search terms you are currently missing, and <Link href="/blog" className="text-primary hover:text-primary-light transition-colors">two free custom blog posts</Link> fully optimized and ready to publish. See our optimization basics in <Link href="/blog/what-is-aeo-for-home-service-businesses" className="text-primary hover:underline transition-colors">AEO for home service businesses</Link>. Let's get started: <Link href="/#calendar" className="text-primary font-bold hover:underline">book a call today</Link>.
            </>
        ),
