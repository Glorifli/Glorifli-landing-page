            ...
            <section className="relative pt-32 pb-20 px-6 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
                        Glorifli is a specialized digital growth agency founded by Brendan Dillon. We build AEO/SEO-optimized client acquisition systems for local service businesses — and we put our money where our mouth is.
                    </p>
                </div>
            </section>
