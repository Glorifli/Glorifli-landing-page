...
export const SERVICES: Record<string, ServiceData> = {
    'autonomous-revenue-engine': {
        ...
        seoDescriptionTemplate: "Glorifli's Autonomous Revenue Engine for {industry} businesses combines a custom website + SEO/AEO system. $1,256.50 setup, free until 10 leads booked.",
        ogDescriptionTemplate: "The complete client acquisition system for {industry} businesses: custom website + AEO/SEO + GBP + citations. 10 leads in 60 days guaranteed.",
        features: [
        ...
        faqs: [
            { q: "What does the Autonomous Revenue Engine include?", a: "Everything: custom website with copywriting and booking system, 8 monthly SEO/AEO blog posts, Google Business Profile optimization, citation network building, AI search (AEO) infrastructure, backend SEO, 60 days of free blog content at launch, priority support, and the 10-leads-in-60-days guarantee. Still not sure if you need this? Read our post on <a href='/blog/why-contractor-business-not-getting-online-leads'>why local businesses struggle to get leads</a>. <a href='/#calendar'>Book a call (plus, we'll optimize your Google My Business profile for free)</a> (plus, we'll optimize your Google My Business profile for free) to see if you qualify." },
            { q: "How does the pricing work for the complete package?", a: "You pay $1,256.50 upfront for the website build. The SEO/AEO service ($589.50/month) runs free until we deliver 10 booked leads within 60 days. After the guarantee is satisfied, you choose whether to continue at $589.50/month. No contracts, no hidden fees. Learn more about <a href='/blog/how-much-does-hvac-marketing-cost'>how much marketing should cost for service businesses</a>. Ready to grow? <a href='/#calendar'>Book your strategy call today (plus, we'll optimize your Google My Business profile for free)</a> (plus, we'll optimize your Google My Business profile for free)." },
            { q: "Why is this called the Autonomous Revenue Engine?", a: "Because once built, the system generates and converts leads automatically — without you needing to run ads, post on social media, or manually chase prospects. Your website ranks, gets cited by AI, books appointments, and captures after-hours leads while you sleep. Check out our deep dive on <a href='/blog/whats-the-best-way-to-get-more-appointments-booked'>how to get more appointments booked</a>. Want it for your business? <a href='/#calendar'>Book a call with us (plus, we'll optimize your Google My Business profile for free)</a> (plus, we'll optimize your Google My Business profile for free)." },
            { q: "What happens if we don't hit 10 leads in 60 days?", a: "The SEO/AEO service keeps running at no charge until we deliver 10 booked leads. The guarantee never expires. There is no scenario in which you pay and don't get results. We discuss this guarantee philosophy in our post about <a href='/blog/why-your-business-growth-has-stalled'>why business growth stalls</a>. Let's hit your goals together—<a href='/#calendar'>book a call here (plus, we'll optimize your Google My Business profile for free)</a> (plus, we'll optimize your Google My Business profile for free)." },
            { q: "How is a $8,900+ value delivered for $1,256.50?", a: "We can offer this because we're betting on our own system. The setup fee covers our build cost. The SEO/AEO portion runs free during the guarantee period. If we deliver (and we do), you become a long-term client at $589.50/month — which is where we build our business. You take zero risk. Wondering about the ROI? Read our post on <a href='/blog/what-is-aeo-for-home-service-businesses'>the value of AEO for service businesses</a>. Secure your launch price by <a href='/#calendar'>booking a call (plus, we'll optimize your Google My Business profile for free)</a> (plus, we'll optimize your Google My Business profile for free)." },
        ]
    },
    'custom-website': {
        ...
        seoDescriptionTemplate: "Glorifli builds custom high-converting websites for {industry} businesses. $1,256.50 one-time setup. 10 leads in 60 days guaranteed.",
