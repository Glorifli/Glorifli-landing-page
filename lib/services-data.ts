...
export const SERVICES: Record<string, ServiceData> = {
    'autonomous-revenue-engine': {
        ...
        roiRows: [
            { industry: "Home Remodeling", avg: "$25,000", revenue: "$75,000", roi: "5,869%", note: "3 closes from 5 appointments" },
            { industry: "Roofing", avg: "$11,500", revenue: "$34,500", roi: "2,646%", note: "3 closes from 5 appointments" },
            { industry: "HVAC", avg: "$8,500", revenue: "$25,500", roi: "1,929%", note: "3 closes from 5 appointments" },
            { industry: "Landscaping", avg: "$4,500", revenue: "$13,500", roi: "974%", note: "3 closes from 5 appointments" },
            { industry: "Plumbing", avg: "$1,800", revenue: "$5,400", roi: "330%", note: "3 closes from 5 appointments" },
        ],
        faqs: [
